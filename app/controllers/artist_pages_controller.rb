class ArtistPagesController < ApplicationController
  ...
  def artist_page_params
    ...
    params.require(:artist_page).permit(:name, :bio, :twitter_handle, :instagram_handle, :bandcamp_handle, :youtube_handle, :external, 
                                        :banner_image_url, :slug, :location, :accent_color, :video_url, :verb_plural, :members,
