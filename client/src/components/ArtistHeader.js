      ...
      <div className="artist-header container">
        ...
        <div className="row">
          <div className="col-md-8">
            ...
            <div className="row">
              <div
                className="col-3 artist-header__members"
              ...
              <div
                className="col-9 artist-header__photos"
                style={{ borderColor: this.props.accentColor }}
              >
          ...
          <div className="col-md-4">
            {/* Right Side */}
            <div className="artist-header__message">
              A Message From The Band
            </div>
            <div
              className="artist-header__message-container"
              style={{ borderColor: this.props.accentColor }}
            >
