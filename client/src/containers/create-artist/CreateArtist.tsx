...
class CreateArtist extends React.Component<CreateArtistProps, any> {
  ...
  renderImages = () => {
    const { images, imageUploads } = this.state;
    ...
    const imageGetter = (index) => {
      if (images[index] && !images[index]._destroy) {
        return images[index];
      }

      return imageUploads[index];
    }
