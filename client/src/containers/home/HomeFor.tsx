    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12">
          <h1 className="home-for__title">Built For Artists</h1>
      ...
      <div className="row">
        <div className="col-md-4">
          ...
          <h3 className="home-for__sub-title">Owned By Artists</h3>
          <p className="home-for__copy">
            Create an artist page and earn an ownership stake in the company. We believe artists should share in the
            value extracted from their content.
          </p>
          <button className="home-for__button btn">Read More</button>
        </div>
        <div className="col-md-4">
          <img className="home-for__image" src={transparent} />
          <h3 className="home-for__sub-title">Transparent Financials</h3>
          <p className="home-for__copy">
            Every cent that goes through Ampled is public and can be tracked to an exact expense as we believe in
