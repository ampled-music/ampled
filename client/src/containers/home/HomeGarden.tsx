        ...
        <div className="col-md-8">
          <div className="row justify-content-center">
            <div className="col-md-4 home-garden__logo_contain">
              <a href="https://www.marketplace.org/2020/04/27/musicians-virtual-concerts-covid19-pandemic/">
            ...
            <div className="col-md-4 home-garden__logo_contain">
              <a href="https://www.salon.com/2020/01/18/how-apunk-inspired-collective-beat-the-streaming-giants-at-their-own-game/">
                <div className="home-garden__logo">
                  <img
                    className="home-garden__logo_image"
                    src={salon}
            ...
            <div className="col-md-4 home-garden__logo_contain">
              <a href="https://www.vice.com/en_us/article/v749p3/theres-no-such-thing-s-independent-music-in-the-age-of-coronavirus">
                <div className="home-garden__logo">
                  <img
                    className="home-garden__logo_image"
                    src={vice}
