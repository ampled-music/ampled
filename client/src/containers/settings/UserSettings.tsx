...
class UserSettingsComponent extends React.Component<Props, any> {
  ...
  renderSocialImages = (artist) => {
    ...
    // prettier-ignore
    promoteImages.push({url:`${BASE_UPLOAD_URL}/c_fill,h_1921,w_1081/l_social:SocialRaw_1/${this.handleBrokenName( artist.name, 'north_west', 160, 150, 80, 65, 'ffffff', '202020'  )}/${this.handlePublicID(artist.image)}`, name:`${cleanArtistName}_promote4.jpg`});
    // prettier-ignore
    promoteImages.push({url:`${BASE_UPLOAD_URL}/b_rgb:${ color + 33 }/${this.handleBrokenName( artist.name, 'north', 0, 560, 100, 85, 'ffffff', '202020'  )}/v1585784142/social/SocialRaw_2.png`, name:`${cleanArtistName}_ promote5.jpg`});
    // prettier-ignore
    promoteImages.push({url:`${BASE_UPLOAD_URL}/b_rgb:${ color + 33 }/v1585784142/social/SocialRaw_4.png`, name:`${cleanArtistName}_promote6.jpg`});
    // prettier-ignore
    promoteImages.push({url:`${BASE_UPLOAD_URL}/b_rgb:${ color + 33 }/v1585784142/social/SocialRaw_5.png`, name:`${cleanArtistName}_promote7.jpg`});
    // prettier-ignore
    promoteImages.push({url:`${BASE_UPLOAD_URL}/b_rgb:${ color + 33 }/v1585784142/social/SocialRaw_6.png`, name:`${cleanArtistName}_promote8.jpg`});
    // prettier-ignore
    promoteImages.push({url:`${BASE_UPLOAD_URL}/b_rgb:${ color + 33 }/v1585784142/social/SocialRaw_7.png`, name:`${cleanArtistName}_promote9.jpg`});
