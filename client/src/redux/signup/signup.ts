...
export const signupAction = createActionThunk(
  actions.signup,
  (username: string, password: string, passwordConfirmation: string, name: string, loginRedirect: string) =>
    signUp(username, password, passwordConfirmation, name, loginRedirect),
);
